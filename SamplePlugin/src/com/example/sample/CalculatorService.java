 ...
 */
public class CalculatorService  extends PluginService {
	...
	public void execute(PluginServiceCallbacks callbacks,
		...
		String result = performCalculation(firstNumber,secondNumber,operator);
		
		if(result==null || result.contains("Error"))
			jsonResults.put("result", "Error");
		else
			jsonResults.put("result", "Success");
		jsonResults.put("data", result);
		PluginResponseUtil.writeJSONResponse(request, response, jsonResults, callbacks, "CalculatorService");
	}
	private String performCalculation(int firstNumber,int secondNumber,String operator){
		String result = null;
		try{
			switch(operator){
			case "+":
